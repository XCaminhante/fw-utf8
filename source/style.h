...
Changes:
   ...
   15-May-1999  RNW  Modified definition of ulong to cater for IRIX.
...
#if OS_OSF
typedef unsigned        ulong_ ; /* Unsigned, [0,(2^32)-1].    Space first.   */
#else
...
// markosius: Since everything outside ASCII can be passed on untouched, I
//  consider it printable! Also everything from space upwards.

#define isascprn(ch) (((ch>=' ') && (ch<='~')) || (ch<0))
