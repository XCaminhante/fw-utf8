...
Changes:
   ...
   08-May-1999  RNW  Added function wr_dup.
...
EXPORT void wf_dup P_((p_wf_t,intchar,ulong));
/* Same as wf_wr but writes specified number of copies of specified char.     */
/* The character must not be a NUL.                                           */
